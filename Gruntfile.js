module.exports = function(grunt) {
    ...
    let gruntConfig = {
        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/themes/shopinicrm/js/clients.min.js': ['assets/themes/shopinicrm/js/clients.js'],
                    'assets/themes/shopinicrm/js/global.min.js': ['assets/themes/shopinicrm/js/global.js'],
        ...
        cssmin: {
            target: {
                files: [{
                        src: ['assets/themes/shopinicrm/css/style.css'],
                        dest: 'assets/themes/shopinicrm/css/style.min.css',
                        ext: '.min.css'
                    },
                    {
        ...
        postcss: {
            ...
            dist: {
                src: [
                    'assets/css/*.css',
                    '!assets/css/*.min.css',
                    'assets/themes/shopinicrm/css/*.css',
                    '!assets/themes/shopinicrm/css/*.min.css',
                ]
            }
        },
        concat: {
        ...
        header: {
            dist: {
                ...
                files: {
                    ...
                    'assets/themes/shopinicrm/js/clients.min.js': 'assets/themes/shopinicrm/js/clients.min.js',
                    'assets/themes/shopinicrm/js/global.min.js': 'assets/themes/shopinicrm/js/global.min.js',
                }
            }
        },
    }
