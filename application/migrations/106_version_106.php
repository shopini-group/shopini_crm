...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'shopinicrm'){
            copy(APPPATH . 'views/themes/shopinicrm/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
