...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/shopinicrm/scripts.php')) {
            @unlink(VIEWPATH . 'themes/shopinicrm/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'shopinicrm') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/shopinicrm/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
