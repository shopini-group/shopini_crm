...
class Staff_model extends App_Model
{
    ...
    public function get_staff_login_data()
    {
        $query=$this->db->get(db_prefix() . 'staff_login');
        return $query->result_array();
    }

    public function get_history_activity_log_data($id)
    {
        $userfullName = get_staff_full_name($id);
        $query = $this->db->get_where('activity_log', array('staffid' => $userfullName));
        return $query->result_array();
    }

    public function get_staff_login_details($id)
    {
        //$query=$this->db->get(db_prefix() . 'staff_login_details');
        $query = $this->db->get_where('staff_login_details', array('staffid' => $id));
        return $query->result_array();
    }
