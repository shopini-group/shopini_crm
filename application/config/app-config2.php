...
*
*/
define('APP_BASE_URL', 'https://demo.localhost/shopini_crm.com/');
...
*/
define('APP_ENC_KEY', 'a5e90525aa613da6dffd3c92be333426');
 ...
 */
define('APP_DB_USERNAME', 'demoshop_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '10stor89AS');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'demoshop_crm');
