               ...
               <div class="panel-body">
                  ...
                  <div class="row mbot15">
                     ...
                     <div class="col-md-2 col-xs-6 border-right">
                        ...
                        <span class="text-info"><?php echo _l('contracts_active'); ?></span>
                     </div>
                     <div class="col-md-2  col-xs-6 border-right">
                        <h3 class="bold"><?php echo $count_expired; ?></h3>
                        <span class="text-danger"><?php echo _l('contracts_expired'); ?></span>
                     </div>
                     ...
                     $_table_data = array(
                      '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',
                       array(
                        ...
                        array(
                           'name'=>_l('contract'),
                           'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-contract-subject')
                        ),
                      );
...
<script>
   $(function(){
       ...
       var tAPI = initDataTable('.table-clients', admin_url+'clients/table', [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1,'desc'))); ?>);
