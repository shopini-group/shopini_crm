...
<div class="modal-header task-single-header" data-task-single-id="<?php echo $task->id; ?>" data-status="<?php echo $task->status; ?>">
   ...
   <h4 class="modal-title"><?php echo $task->name; ?> - <?php echo $task->id?></h4>
         ...
         <div id="call_log_outer">
                  ...
                  <div id="call_log_button">
                     ...
                     <?php if(has_permission('call_logs','','create')){ ?>
                        <a href="<?php echo admin_url('call_logs/call_log?customer_type=lead'); ?>" class="btn btn-info mbot25"><?php echo 'Create Call Log'; ?></a>
                     <?php } ?>
                  </div>
