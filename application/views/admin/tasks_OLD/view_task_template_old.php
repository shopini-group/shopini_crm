   ...
   <div class="row">
      ...
      <div class="col-md-4 task-single-col-right">
         ...
         <h5 class="no-mtop task-info-created">
            ...
            <small class="text-dark"><?php echo _l('task_created_at',_dt($task->dateadded)); ?><?php //echo _l('task_created_by','<span class="text-dark">'.($task->is_added_from_contact == 0 ? get_staff_full_name($task->addedfrom) : get_contact_full_name($task->addedfrom)).'</span>'); ?> <!--<i class="fa fa-clock-o" data-toggle="tooltip" data-title="<?php //echo _l('task_created_at',_dt($task->dateadded)); ?>"></i></small>-->
            <br />
            <?php } else { ?>
