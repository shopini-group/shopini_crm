...
foreach ($rResult as $aRow) {
    ...
    $row[] = $aRow['call_log_id'] != '' ? "<a target='_blank' href='".admin_url('call_logs/preview/'.$aRow['call_log_id'])."'>View Call Log</a>" : '';
    ...
    $row[] = _d($aRow['startdate']).' - '.substr($aRow['dateadded'], 10);//remove first 10 chr for display time
