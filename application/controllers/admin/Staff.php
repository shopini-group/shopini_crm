...
class Staff extends AdminController
{
    ...
    public function member($id = '')
    {
        ...
        if ($id == '') {
            ...
            $staff_login_data = $this->staff_model->get_staff_login_data();
            $staff_login_details = $this->staff_model->get_staff_login_details($member->staffid);
            ...
            $data['staff_login_data']  = $staff_login_data;
            $data['staff_login_details']  = $staff_login_details;
            

            $data['member']            = $member;
            $history_activity_log  = $this->staff_model->get_history_activity_log_data($member->staffid);
            $data['history_activity_log'] = $history_activity_log;
