...
/* This functions tie up Shopini CRM permission system with Call Log Module. */
...
function call_logs_module_init_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('call_logs_menu', [
        'name' => _l('logs'), // The name if the item
    ...
    $CI->app_menu->add_sidebar_children_item('call_logs_menu', [
        'slug'     => 'call_logs',
        'name'     => _l('call_logs'),
        'icon'     => 'fa fa-phone',
    ...
    $CI->app_menu->add_sidebar_children_item('call_logs_menu', [
        ...
        'name'     => _l('visit_logs'),
        'icon'     => 'fa fa-meetup',
        'href'     => admin_url('call_logs?type=visit'),
        'position' => 2,
]);
