        ...
        <div class="wiki-buttons-wrap">
            <div>
                <?php if(has_permission('wiki_articles','','create')){ ?>
                    <a href="<?php echo admin_url('wiki/articles/article'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('wiki_new_article'); ?></a>
                <?php } ?>
            </div>
            <div>
                <?php 
            ...
            <div class="wiki-search-wrap">
                ...
                <div class="input-group">
                    ...
                    <input type="search" class="form-control input-sm input-search-list" value="<?php echo $filter_query; ?>" placeholder="<?php echo _l('wiki_search'); ?>...">
                </div>
            </div>
        </div>
