                ...
                <div class="panel_s">
                    <div class="panel-body">
                            ...
                            <div class="col-md-4">
                                <?php if(isset($article)){ ?>
                                    <div class="checkbox checkbox-primary">
                                        <small><?php echo _l('get_link_help'); ?></small>
                        ...
                        <div class="btn-bottom-toolbar btn-toolbar-container-out text-right">
                            <a href="<?php  echo isset($back_url) ? $back_url : admin_url('wiki/articles'); ?>" class="btn btn-primary"><?php echo _l('back'); ?></a>
                            <?php if(isset($article)){ ?> 
                            ...
                            <?php } ?>
                            <button type="submit" name="submit" value="ONLY_SAVE" class="btn btn-info"><?php echo _l('submit'); ?></button>
                         </div>
